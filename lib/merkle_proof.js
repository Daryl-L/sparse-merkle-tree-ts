...
class MerkleProof {
    ...
    clone() {
        ...
        for (let v of this.leaves_bitmap) {
            cloned.leaves_bitmap.push(new h256_1.default(v.to_array()));
        }
        ...
        while (pc < this.length) {
            ...
            switch (code) {
                ...
                case 0x50:
                    ...
                    parent = (() => {
                        if (key.is_right) {
                            return (0, util_1.merge)(height, parent_key, sibling, value, this.hasherFactory);
                        }
                        else {
                            return (0, util_1.merge)(height, parent_key, value, sibling, this.hasherFactory);
                        }
                    })();
                ...
                case 0x51:
                    ...
                    parent_key = key.parent_path(height);
                    sibling = new merge_1.MergeValueWithZero(this.hasherFactory, base_node, zero_bits, zero_count);
                    parent = (() => {
                ...
                case 0x48:
                    ...
                    if (!parent_key.equal(key_b.parent_path(height_b))) {
                        throw new errors_1.CorruptedProofError;
                    }
                    parent = (() => {
                        if (key_a.is_right(height_a)) {
                            return (0, util_1.merge)(height_a, parent_key, value_b, value_a, this.hasherFactory);
                        }
                        else {
                            return (0, util_1.merge)(height_b, parent_key, value_a, value_b, this.hasherFactory);
                        }
                    })();
                ...
                case 0x4f:
                    ...
                    for (let i = 0; i < n; i++) {
                        ...
                        value = ((height) => {
                            parent_key = key.parent_path(height);
                            if (key.is_right(height)) {
                                return (0, util_1.merge)(height, parent_key, new merge_1.MergeValueNormal(h256_1.default.zero()), value, this.hasherFactory);
                            }
                            else {
                                return (0, util_1.merge)(height, parent_key, value, new merge_1.MergeValueNormal(h256_1.default.zero()), this.hasherFactory);
                            }
                        })(height + i);
                    }
