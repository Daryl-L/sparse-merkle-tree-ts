...
export const merge = (height: u8, node_key: H256, left: MergeValue, right: MergeValue): MergeValue => {
  ...
  let hasher = util.blake2b(32, null, null, PERSONAL);
  hasher
...
const merge_with_zero = (height: u8, node_key: H256, value: MergeValue, set_bit: boolean): MergeValueWithZero => {
